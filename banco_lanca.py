...
banco = sqlite3.connect(str(os.path.dirname(os.path.abspath(__file__)))+'database.db')
cursor = banco.cursor()
...
if __name__ == "__main__":
    ...
    print(df.head()) """
    '''for i in range(len(filtro("dados","AMERICA DO NORTE","CHILE","Tal","Tal"))):
        print("\n",filtro("dados","AMERICA DO NORTE","CHILE","Tal","Tal")[i])'''
    #print('aaaaa',str(os.path.dirname(os.path.abspath(__file__))))
    print(acessa_dado_4_cond('Tipo','dados','Grupo','Usiminas','Site','Ipatinga1','bico_id','3','carro','Leste')[0][0])
